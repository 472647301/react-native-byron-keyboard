...
import com.byron.keyboard.ByronKeyBoardView;

import java.lang.reflect.Method;

public class RNByronKeyboardModule extends ReactContextBaseJavaModule {
    private final int TAG_ID = 0xdeadbeaf;
    private final ReactApplicationContext reactContext;
    private ReactEditText curEditText;
    private boolean showKeyboard = false;

    public RNByronKeyboardModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void install(final int tag, final int height) {
        UiThreadUtil.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                edit.setTag(TAG_ID, createCustomKeyboard(activity, tag, height));
    ...
    private View createCustomKeyboard(Activity activity, int tag, int height) {
        RelativeLayout layout = new RelativeLayout(activity);
        rootView = new ByronKeyBoardView(this.getReactApplicationContext());
        ...
        RelativeLayout.LayoutParams lParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, Math.round((height+54)*scale));
